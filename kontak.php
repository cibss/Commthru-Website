            ...
            <div class="main_menu" id="mainNav">
                <nav class="navbar navbar-expand-lg navbar-light">
                    <div class="container box_1620">
                        ...
                        <a class="navbar-brand logo_h" href="index.html"><img src="img/logo_comm.png" style="width:145px;height:37px;"></a>
                    ...
                    <div class="col-lg-12">
                        <div class="progress-table-wrap">
                            <div class="progress-table">
                                ...
                                <div class="table-row">
                                    <div class="serial">PR001</div>
                                    <div class="country">Apartment Project</div>
                                    <div class="visit">Vine Wood Apartment</div>
                                    <div class="visit"><a href="view_contact.html">View contact</a></div>
